...
#define FIREBASE_HOST "https://heli-control-default-rtdb.asia-southeast1.firebasedatabase.app/"
#define FIREBASE_AUTH "kRrfPCtYvFwV5wgdUoZQoMvVrFtPrBV6UQoeroLg"
...
void connectToWiFi() {
  ...
  if (!wifiManager.autoConnect("Speed Control Connection")) {
    // Reset and try again
    ESP.reset();
    delay(5000);
  }
